<?php
  ...
  if (isset($_SESSION['ID'])&&isset($_SESSION['Name'])&&isset($_SESSION['email'])&&$_SESSION['user']===$admin) {
    ...
    $sql = "SELECT `docID`, `docName`, `type`, `phoneNo`, `email` FROM `doctors`; ";
...
?>
    ...
    <html lang="en">
      <head>
        ...
        <title>Admin · Doctors || E.H.S</title>
        ...
        <div class="row">
          ...
          <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
              <h1 class="h2">Doctors Dashboard</h1>
                  ...
                  <form action="docregistration.php" method="post">
                    <div class="row">
                      <div class="form-group col-md-6">
                        <label for="inputName">Doctor's Name <span style="color:red">*</span></label>
                        <input type="text" class="form-control" id="inputName" placeholder="Charlie Joe" name="doctor" required>
                      </div>
                      <div class="form-group col-md-6">
