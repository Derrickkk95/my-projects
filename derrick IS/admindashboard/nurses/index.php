<?php
  ...
  if (isset($_SESSION['ID'])&&isset($_SESSION['Name'])&&isset($_SESSION['email'])&&$_SESSION['user']===$admin) {
    ...
    $sql = "SELECT `nurseID`, `nurseName`, `phoneNo`, `email` FROM `nurses`;";
...
?>
    ...
    <html lang="en">
      <head>
        ...
        <title>Admin · Nurses || E.H.S</title>
        ...
        <div class="row">
          ...
          <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
              <h1 class="h2">Nurses Dashboard</h1>
              ...
              <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Add Nurse Form</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                  <h1 class="h6 mb-3 fw-normal">Fields marked with <span style="color:red">*</span> are required</h1>
                  <form action="nurseregistration.php" method="post">
                    <div class="row">
                      <div class="form-group col-md-12">
                        <label for="inputName">Nurse Name <span style="color:red">*</span></label>
                        <input type="text" class="form-control" id="inputName" placeholder="Charlie Joe" name="nurse" required>
                      </div>
                      <!-- <div class="form-group col-md-6">
                        <label for="inputSpecialization">Specialization <span style="color:red">*</span></label>
                        <input type="text" class="form-control" id="inputSpecialization" placeholder="eg. surgeon" name="spec" required>
                      </div> -->
                    </div>
                    <div class="row">
                      <div class="form-group col-md-6">
                    ...
                    <div class="form-row" id="pswdentry">
                      <div class="form-group col-md-6">
                    ...
                    <div class="form-group">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="gridCheck" name="defaultpassword" onclick="defaultPassword()">
